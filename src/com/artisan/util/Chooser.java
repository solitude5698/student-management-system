...
public class Chooser extends JPanel{
    ...
    private static int defaultStartDAY = 0;//0 从周日开始, 1 从周一, 2 从周二
    private static Color hoverColor = Color.BLUE; // 悬浮颜色
    ...
    private class TitlePanel extends JPanel {
        ...
        private void initTitlePanel(){
            ...
            preMonth.setToolTipText("上一个月");
            nextMonth.setToolTipText("下一个月");
        ...
        private void updateDate() {
            center.setText(calendar.get(Calendar.YEAR)+"年"+(calendar.get(Calendar.MONTH) + 1)+"月");
        }
        // 控制标签的监听器
    ...
    private class BodyPanel extends JPanel {
        ...
        public void updateDate() {
            ...
            // 从当月1号往前推，一直移动到显示的第一天（上一个月），-index + defaultStartDAY为负数时为上一个月，从当月1号之后开始显示需要往前推一个月，确保显示完整
    ...
    private class FooterPanel extends JPanel {
        ...
        private void initFooterPanel(){
            dateLabel = new JLabel("今日："+sdf.format(new java.util.Date()));
    ...
    private class LabelManager {
        ...
        public void setSelect(Point p, boolean b) {
            //处理鼠标拖拽，需要优化一下，提升效果  
            if (b) {
                //标记是否能拖动，设置比较所有的标签，能拖动的标志是前一个和后一个标签
                //要显示的标签找到了就可以返回  
